...
"""
copy and edit of from gym.wrappers.atari_preprocessing import AtariPreprocessing 
    ...
    * Scale observation: optional
    ...
    def reset(self, **kwargs):
        ...
        for _ in range(noops):
            _, _, done,_, step_info = self.env.step(0) #obs,r,done,truncated,info
        ...
        if kwargs.get("return_info", False):
            ...
            return self._get_obs(),reset_info #always true
